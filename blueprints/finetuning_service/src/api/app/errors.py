...
class ConflictError(OpenAIError):
    """Conflicting state error (409)

    For requests that are well formed but cannot be carried out in the current
    state, e.g. deploying a model whose deployment is already running.
    """
